layui.use(['table', 'laytpl', 'form', 'common','laydate'], function() {
    ...
    var dataTable = common.renderTable({
	    url: common.getUrl(rootPath + '/mongo/adminactionlog/list'),
	    where:  $(".data-list-form").serializeJSON(),
	    cols: [[
	      {field:'id', title: 'ID', width:150, sort: true},
	      {field:'adminName', title: '管理员用户名', width: 100},
	      {field:'action', title: '访问路径', width: 300},
	      {field:'ip', title: 'IP地址', width: 150},
	      {field:'createTime', title: '操作时间', width: 180},
	      {field:'actionPara', title: '参数', width: 300},
    ...
    table.on('tool(data-list)', function(obj){
		...
		case 'details':
			layer.open({
				...
				area: ['55%','37%'],
				shadeClose: true,
				content: rootPath + '/mongo/adminactionlog/detail?id='+data.id
			});
			break;
		default:
			break;
