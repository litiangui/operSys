 ...
 * 接口接受参数
 */
@ApiModel(value="app启动页广告参数Dto",description="app启动页广告接口参数Dto")
@lombok.Data
@lombok.AllArgsConstructor
@lombok.NoArgsConstructor
public class BaseHomePageParamDto implements Serializable{
	private static final long serialVersionUID = 1L;

	@ApiModelProperty(hidden=true)
	private String paramsStr;	//原参数

	@ApiModelProperty(value = "接口对应Code{5001:获取app启动页广告列表,5002:获取爱之家邀请页数据列表,5003:砍价商品财务审核}", name="code",example="5001",allowableValues="5001")	
