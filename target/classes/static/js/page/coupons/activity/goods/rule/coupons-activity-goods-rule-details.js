layui.use(['table', 'laytpl', 'laydate', 'form', 'common'], function() {
    ...
    var dataTable = common.renderTable({
	    ...
	    cols: [[
	      ...
	      {field:'refSignValue', title: '规则关联值code', width: 300},
          {field:'ruleType', title: '规则类型', width: 200,templet:function(val,row){
            ...
            {field:'refSignName', title: '商品名称', width: 300},
	...
	$('.btn-add').click(function(data){
	    ...
	    if (rtype==="5"){
            ...
            layer.open({
                ...
                area: ['95%', '95%'],
                shadeClose: true,
                content: rootPath + "/coupons/activity/goods/rule/detailsSetting?ruleId="+ruleid+"&id="+0,
                success:function (layero,index) {
            ...
            case 'reed':
                if (rtype==="5"){
                    layer.open({
                        ...
                        area: ['95%', '95%'],
                        shadeClose: true,
                        content: rootPath + "/coupons/activity/goods/rule/supdetails",
                        success:function (layero,index) {
                    ...
                    layer.open({
                        ...
                        area: ['95%', '95%'],
                        shadeClose: true,
                        content: rootPath + "/coupons/activity/goods/rule/detailsSetting?ruleId="+ruleid+"&id="+data.id,
                        success:function (layero,index) {
                            $(".submit", layero.find("iframe")[0].contentWindow.document).hide();
                            $(".search", layero.find("iframe")[0].contentWindow.document).hide();
