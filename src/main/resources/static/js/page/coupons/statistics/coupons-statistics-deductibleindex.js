	layui.use(['table', 'laytpl', 'form', 'common', 'laydate','element' ], function() {
	    ...
	    var dataTable = common.renderTable({
	    	// height:'full-number' ,
		    url: common.getUrl('/coupons/statistics/deductiblelist'),
		    where:  $(".data-list-form").serializeJSON(),
		    cols: [[
                {field:'statisticsTime', title: '日期', width: 150,templet:function(val){
                        return val.statisticsTime.split(" ")[0];
                    }},
			      {field:'userNum', title: '获取抵扣券用户数', width: 180},
			      {field:'usedAmount', title: '抵扣券使用金额', width: 180},
			      {field:'usedNum', title: '抵扣券使用人数', width: 180},
			      {field:'deleteNum', title: '升级清空人数', width: 180},
			      {field:'deleteAmout', title: '清空总余额', width: 180},
			      {field:'balanceTotal', title: '余额总数', width: 180},
			      {field:'loseNum', title: '未获取抵扣券数', width: 180},
			    ]],
	    });
		 $("#reload").click(function(){
	    ...
	    $("#reload2").click(function(){
	    	...
	    	var opt={url: common.getUrl('/coupons/statistics/cashlist?timeRange2='+$("#timeRange2").val())};
				  ...
				  if(tmp==1){
					...
					tab2=table.render({
						  ...
						  ,cols: [[
                            ...
                            {field:'userNum', title: '获取代金券用户数', width: 180},
                            {field:'usedAmount', title: '代金券使用金额', width: 180},
                            {field:'usedNum', title: '代金券使用人数', width: 180},
                            // {field:'deleteNum', title: '升级清空人数', width: 180},
                            // {field:'deleteAmout', title: '清空总余额', width: 180},
                            {field:'balanceTotal', title: '余额总数', width: 180},
                            // {field:'loseNum', title: '未获取抵扣券数', width: 180},
