...
layui.define(['jquery','layer','cropper'],function (exports) {
    var $ = layui.jquery,common = layui.common
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/operSys/js/page/cropper/cropper.css\">\n" +
        "<div id='cropperDiv' class=\"layui-fluid showImgEdit\" style=\"display: none\">\n" +
        "    <div class=\"layui-form-item\"><a id='closeBtn' style='display:none' class='layui-layer-ico layui-layer-close layui-layer-close1' href='javascript:;'></a>\n" +
