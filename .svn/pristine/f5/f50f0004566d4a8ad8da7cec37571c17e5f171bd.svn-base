layui.use(['table', 'laytpl', 'laydate', 'form', 'common'], function() {
    ...
    /*		if(tempIsSale==0){
              ...
              $.ajax({
                    type: 'GET',
                    url:  rootPath + '/mongo/homepage/saveVipGoods?code='+code+"&sort="+$("#sort").val(),
                    dataType: "json",
    ...
    $(".search").click(function(){
        ...
        $.ajax({
            ...
            success: function (msg) {
            	...
            	if (msg.code==="false"){
                    common.hide();
                    layer.alert("请输入正确的商品code",{icon: 2});
                    return false;
                }
   ...
   // var productJson=JSON.parse(product);
    ...
    if(operTypeTmp==2){
        ...
        var activityGoodsRuleDetailsResultJson=JSON.parse(activityGoodsRuleDetailsResult);
    	console.info(activityGoodsRuleDetailsResultJson)
     	if(temp.productCode!=null&&temp.productCode!=''){
        	...
        	$("#sort").val(activityGoodsRuleDetailsResultJson.sort);
    	...
    	if(activityGoodsRuleDetailsResultJson!=null&&activityGoodsRuleDetailsResultJson!=''){
        	$("#activityGoodsRuleId").val(activityGoodsRuleDetailsResultJson.activityGoodsRuleId);
