layui.use(['table', 'laytpl', 'laydate', 'form', 'common'], function() {
    ...
    $("._submit").click(function(){
        ...
        var groupItemId=$("#groupItemId").val();
        var goodsItemId=$("#goodsItemId").val();
        var moduleId=$("#moduleId").val();
        var id=$("#id").val();
        var isItemGoods=$("#isItemGoods").val();
        ...
        if (isItemGoods==="1"){
            $.ajax({
                type: 'POST',
                url:  rootPath + '/mongo/homepage/addItemGoods',
                data:{id:id,groupItemId:groupItemId,goodsItemId:goodsItemId,moduleId:moduleId,goodsCode:productCode,sortNum:sortNum},
                dataType: "json",
            ...
            $.ajax({
                type: 'POST',
                url:  rootPath + '/mongo/homepage/addgoods',
                data:{id:id,groupItemId:groupItemId,goodsItemId:goodsItemId,moduleId:moduleId,goodsCode:productCode,sortNum:sortNum},
                dataType: "json",
                success: function (msg) {
                    if (msg.ok){
