 ...
 */
@Data
public class CommodityOrderStatisticsDto implements Serializable {
	...
	public Double getAverageCustomerSpending() {
		if (this.hasPaysTotalOrdersCounts != null && this.hasPaysTotalOrdersCounts != 0) {
	 ...
	 * 新增注册人数
	 */
	private Integer registCounts=0;
}
